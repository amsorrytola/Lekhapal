...
⚠️ Extraction Rules:
- [span_0](start_span)[span_1](start_span)Each member's loan record section (e.g., "Meमूना बाबू पटेल" or "Lalita") is a separate table.[span_0](end_span)[span_1](end_span)
- [span_2](start_span)[span_3](start_span)[span_4](start_span)[span_5](start_span)[span_6](start_span)Use the member's name as the "title" for each table object.[span_2](end_span)[span_3](end_span)[span_4](end_span)[span_5](end_span)[span_6](end_span)
